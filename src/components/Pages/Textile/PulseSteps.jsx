      ...
      <div className="w-full bg-white py-16 font-['NeueMontreal']">
        <div className="max-w-[1400px] mx-auto px-6 text-center">
          ...
          <motion.h1
            ...
            className="text-4xl lg:text-6xl !font-KuraleRegular  text-black mb-6 leading-none tracking-tighter"
          >
          ...
          >
            Explore our integrated production, sustainable practices, and global
            standards that make us a preferred partner in the textile industry.
          </motion.p>
        </div>
      </div>
      ...
      <div className="relative w-full overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 select-none pointer-events-none">
          ...
          >
            ...
            <source
              src="https://www.pexels.com/download/video/30183205/"
              type="video/mp4"
            />
          </video>
