        ...
        <ProcessTimelineSection
            ...
            headerContent={
                <>
                    ...
                    >
                        These efforts reduce our environmental footprint while delivering high-performance, responsibly produced fabrics.
                    </motion.p>
                </>
            }
            renderItemContent={(item) => (
                <>
                    ...
                    <p className="text-sm lg:text-base text-gray-700 font-['NeueMontreal'] leading-relaxed max-w-sm ml-auto lg:ml-auto lg:mr-0">
                        {item.desc}
                    </p>
                </>
            )}
