...
const slides = [
    {
        ...
        description: "Industrial warehouses, factories, and manufacturing sheds designed for maximum efficiency and durability.",
    ...
    },
    {
        ...
        description: "Commercial structures, including showrooms, malls, and multi-level car parks that combine aesthetics with structural integrity.",
        image: "https://images.pexels.com/photos/374023/pexels-photo-374023.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
    },
    {
        id: 3,
        tag: "Infrastructure",
        title: "Infrastructure Projects",
        description: "Infrastructure projects such as rail over bridges, metro stations, and hangars built for critical networks.",
    ...
    },
    {
        ...
        description: "Specialised buildings like indoor stadiums, auditoriums, and high-rise steel structures engineered for unique requirements.",
    ...
    },
    {
        ...
        description: "Custom designs with clear spans up to large widths, mezzanines, and crane integrations tailored to your specific needs.",
        ...
        <PortfolioSliderSection
            subtitle={
                <div className="flex items-center gap-2 mb-2">
                    <span className="text-[#BB2929] font-semibold text-sm uppercase tracking-widest font-['NeueMontreal']">Our PEB Portfolio</span>
