          ...
          <div className="flex flex-col w-full lg:w-1/3 gap-4">
            {infrastructureFeatures.map((feature) => (
              <button
                ...
                className={`flex items-center justify-between px-6 py-5 rounded-sm transition-all duration-300 group text-left ${
              ...
              >
                <span
                  className={`font-semibold text-sm md:text-base ${activeFeature.id === feature.id ? "font-semibold" : ""}`}
                >
                  {feature.title}
                </span>
                {activeFeature.id === feature.id ? (
          ...
          <div className="w-full lg:w-1/3 flex justify-center">
            <div className="relative bg-[#1A1A1A] w-full max-w-md aspect-[3/4] p-6 flex flex-col justify-between rounded-sm shadow-xl">
              ...
              <div className="flex items-end justify-between text-white/40 font-FoundersGroteskCondensed mt-4">
                ...
                <span className="text-5xl md:text-6xl leading-none text-white/20 font-bold">
                  {activeFeature.id}
                </span>
              </div>
            </div>
