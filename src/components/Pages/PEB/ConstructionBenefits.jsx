...
const benefits = [
    {
        ...
        description: "Comprehensive solutions from design to erection for faster project delivery."
    },
    {
        id: "02",
        title: "STATE-OF-THE-ART FACILITY",
        description: "Advanced infrastructure with proven expertise in diverse PEB applications."
    },
    {
        id: "03",
        title: "CUSTOMISATION CAPABILITIES",
        description: "Tailored to meet unique structural and functional requirements."
    },
    {
        id: "04",
        title: "SUSTAINABLE ENGINEERING",
        description: "Cost-effective, sustainable buildings designed with world-class engineering."
    },
    {
        id: "05",
        title: "REVITALISED LEADERSHIP",
        description: "Under new ownership, committed to innovation, quality, and client success."
    }
];
...
const ConstructionBenefits = () => {
    return (
        <section className="w-full bg-white py-20 px-6 md:px-20 font-['NeueMontreal'] relative overflow-hidden">
            <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 relative z-10">
                ...
                <div className="w-full lg:w-1/2 flex flex-col gap-8">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <h2 className="text-4xl md:text-6xl font-bold font-FoundersGroteskCondensed leading-tight text-black">
            ...
            <div className="absolute top-1/2 right-[-2%] transform -translate-y-1/2 rotate-180 pointer-events-none select-none z-0 opacity-[0.03] hidden lg:block">
                <h1
                    className="text-[12rem] xl:text-[20rem] font-bold font-FoundersGroteskCondensed uppercase text-black"
