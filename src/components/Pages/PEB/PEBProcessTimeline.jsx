...
const timelineData = [
    {
        ...
        footer: "This phase ensures efficient, economical designs that accelerate project timelines."
    },
    {
        title: "Fabrication",
        ...
        footer: "These processes deliver components with superior strength, minimal waste, and ready-for-site assembly."
    },
    {
        ...
        footer: "This results in buildings that are functional, energy-efficient, and visually appealing."
    },
    {
        title: "Erection",
        ...
        footer: "Our approach achieves 30-50% faster completion compared to conventional methods."
    }
];
        ...
        <ProcessTimelineSection
            ...
            headerContent={
                <>
                    ...
                    >
                        Our streamlined process ensures precision, speed, and quality at every stage of your building's creation.
                    </motion.p>
                </>
            }
            renderItemContent={(item, isLeft) => (
                <>
                    ...
                    {/* Bullets */}
                    <ul className={`text-sm text-gray-600 space-y-2 mb-6 ${isLeft ? 'lg:pl-8' : 'lg:pr-8'} list-disc list-inside lg:list-outside marker:text-[#BB2929]`}>
                        {item.bullets.map((bullet, i) => (
                            <li key={i}>{bullet}</li>
                        ))}
                    </ul>
                    <p className={`text-sm font-semibold text-gray-800 italic ${isLeft ? 'lg:border-r-4 lg:pr-4 lg:border-l-0 border-l-4 pl-4' : 'border-l-4 pl-4'} border-[#BB2929]`}>
                        {item.footer}
                    </p>
                </>
            )}
